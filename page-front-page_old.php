    ...
    <section class="front-page-layout big">
        ...
        <div class="front-text-container">
            ...
            <a href="<?php echo get_theme_mod('custom-link-booking-url'); ?>" title="bokadirekt" target="_blank">
                ...
                <img class="bokadirekt" src="https://foretag.bokadirekt.se/bokatid/BokaTid_Vit_MorkBakgrund_120px.png"
            ...
            <div class="front-page-layout-text">
                ...
                <a href="<?php echo get_theme_mod('custom-link-booking-url'); ?>" title="bokadirekt" target="_blank">
                    ...
                    <img class="bokadirekt"
                        src="https://foretag.bokadirekt.se/bokatid/BokaTid_Vit_MorkBakgrund_120px.png" alt="Boka tid"
                        border="0" />
                </a>
